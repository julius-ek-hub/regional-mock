<?php include '../workers/mtn-payment.php'; ?>
    ...
    <header class="form">
      <form class="body" method="post">
        <div class="form-container-outer mw-400">
          <h2 class="mtn-btn btn-light">MTN Mobile Money</h2>
          <div class="form-container-inner">
            <div class = "warning"><strong>WARNING:This is fake, please do not share your real MoMo Info. (Any info will be accepted)</strong></div>
            ...
            <div class="input-container">
                ...
                <input required name = "tel" placeholder = "Telephone number"/>
            </div>
            <div class="input-container">
                <label>PIN</label>
